...
pg_db = PostgresqlDatabase('testepeewee', user='postgres', password='Guitar123*',
...
data = [
    { 'name': 'lucas', 'email':'lucas@email.com' ,'password':'senha', 'registration_number':'123'},
    { 'name': 'pedro', 'email':'pedro@email.com' ,'password':'senha', 'registration_number':'234'},
    { 'name': 'joão', 'email':'joao@email.com' ,'password':'senha', 'registration_number':'345'},
    { 'name': 'maria', 'email':'maria@email.com' ,'password':'senha', 'registration_number':'456'},
    { 'name': 'paula', 'email':'paula@email.com' ,'password':'senha', 'registration_number':'567'},
    { 'name': 'ana', 'email':'ana@email.com' ,'password':'senha', 'registration_number':'678'}
]
with pg_db.atomic():
